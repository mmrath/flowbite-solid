...
export const FooterBrand: Component<FooterBrandProps> = (props) => {
  ...
  return (
    <div>
      {props.href ? (
        <a data-testid="flowbite-footer-brand" href={props.href} class={classNames(theme.base, props.class)}>
        ...
        <img alt={props.alt} data-testid="flowbite-footer-brand" src={props.src} class={theme.img} />
      )}
    </div>
  );
};
