...
import { HiSolidGlobe as HiGlobe, HiSolidLockClosed as HiLockClosed } from "solid-icons/hi";
...
const TestForm = (): JSX.Element => (
  <form>
    ...
    <fieldset>
      ...
      <div>
        <Radio id="united-state" name="countries" value="USA" checked={true} />
        <Label for="united-state">United States</Label>
      </div>
      <div>
