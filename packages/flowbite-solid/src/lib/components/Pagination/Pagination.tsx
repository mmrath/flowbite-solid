...
import {HiSolidChevronLeft as HiChevronLeft, HiSolidChevronRight as HiChevronRight} from 'solid-icons/hi';
import range from '../../helpers/range';
import {useTheme} from '../Flowbite';
import PaginationButton, {PaginationButtonProps} from './PaginationButton';
import {ComponentProps, createMemo, For, JSX, mergeProps, ParentProps, Show, splitProps} from "solid-js";
...
export const Pagination = (p: PaginationProps): JSX.Element => {
    ...
    const [local, props] = splitProps(mergeProps(defaultProps, p), ["class", "currentPage", "layout",
        "onPageChange", "showIcons", "totalPages", "previousLabel", "nextLabel", "renderPaginationButton"]);
    ...
    return (
        <nav class={classNames(theme().base, local.class)} {...props}>
            ...
            <ul class={theme().pages.base}>
                <li>
                    <Dynamic component={local.renderPaginationButton}
                             class={classNames(theme().pages.previous.base, local.showIcons && theme().pages.showIcon)}
