...
export default function AccordionDemo() {
    ...
    return (
        <div class={"gap-4 p-5"}>
            ...
            <Accordion flush={flush()} collapseAll={collapseAll()} alwaysOpen={alwaysOpen()} class={"mt-5"}>
                ...
                <Accordion.Panel eventKey={"3"}>
                    ...
                    <Accordion.Content>
                        ...
                        <p class="mb-2 text-gray-500 dark:text-gray-400">
                            ...
                            there
                            is no technical reason stopping you from using the best of two worlds.
                        </p>
                        <p class="mb-2 text-gray-500 dark:text-gray-400">
